package com.bluekhata.utils.horizontalcalendar;
...
public final class HorizontalCalendar {
    ...
    static HorizontalCalendar getInstance(Builder builder){
        if (horizontalCalendar == null){
            horizontalCalendar = new HorizontalCalendar(builder);
        }
...
//            HorizontalCalendar horizontalCalendar = HorizontalCalendar.getInstance(this);
