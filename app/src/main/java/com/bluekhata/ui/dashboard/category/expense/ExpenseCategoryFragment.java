...
import com.bluekhata.databinding.FragmentCategoryExpenseBinding;
import com.bluekhata.di.dependency.ActivityDependency;
import com.bluekhata.di.dependency.AppDependency;
import com.bluekhata.di.dependency.ExpenseCategoryDependency;
...
public class ExpenseCategoryFragment extends BaseFragment<FragmentCategoryExpenseBinding, ExpenseCategoryViewModel> implements OnCustomerListChangedListener,
    ...
    public void onCategoryListUpdate(List<Category> categoryList) {
        viewModel.updateCategoryList(categoryList);
    }
