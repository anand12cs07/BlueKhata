...
public abstract class TransactionTagDao {
    ...
    public abstract int updateTransaction(com.everyrupee.data.model.db.Transaction transaction);
    ...
    @Transaction
    public void updateTransaction(List<String> tagTitles, com.everyrupee.data.model.db.Transaction transaction){
